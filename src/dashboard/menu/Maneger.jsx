    ...
    <div className="">
      ...
      <div className="rounded-t-lg mt-[24px]">
        <div className="flex py-[22px] justify-between items-center">
            <div>
          <p className=" text-[24px]">Manager List</p> 
            </div>
            <div className="flex items-center">
         <Link to = "/dashboard/maneger/addmaneger">
         <button className="bg-[#b1c27f] text-white px-2 py-1 mr-2 rounded-xl flex items-center"> 
         <FaPlusCircle /> <p>Add maneger</p></button>
         </Link>
          <Search style={{
            width:"200px"
