...
const Notification = () => {
    return (
        ...
        <div className="mt-8 flex border rounded border-[#00BF63] items-center w-full h-[85px]">
         <div> 
              <p className=""><IoMdNotificationsOutline className=" h-12 w-12 ml-4 border rounded-full p-2 border-[#00BF63] text-[#00BF63]" />
              </p>
         </div>
         <div> 
              ...
              <p className='text-[18px] ml-8 font-medium text-[#00BF63]'>2 minute ago</p>
